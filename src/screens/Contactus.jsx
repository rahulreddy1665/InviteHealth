import {
    Container, createStyles, Grid, Group,
    Paper, rem, Text, Title
} from "@mantine/core";
    ...
    return (
      <>
        ...
        <Grid justify="center" gutter="xl">
          <Grid.Col md={5} sm={6}>
            <Paper shadow="md" radius="sm" mt={-40} style={{ minHeight: 285 }}>
          ...
          <div  style={{overflow: "hidden",marginTop:-40,}}>
                    <iframe
                        ...
                        width="600" height="305" className="map" loading="lazy" title="Company map"></iframe>
                </div>
